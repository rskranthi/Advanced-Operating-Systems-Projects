...
/*
extern int data_record[100][3],outcome_record[100][2]; // Arrays to hold the data and outcome records

extern char data_id;
extern int ROWS=10,COLS=3;
extern int PENDING=0,COMMITTED=1,ABORTED=-1; //Initializing variables as its easy to deal in numbers
extern int outcome_temp[100][3],commit_pointer=0;//outcome records for temp and committed values
extern int outcome_pointer=0,data_pointer=0,new_action_pointer=0;//pointers to handle the above declared arrays
*/
